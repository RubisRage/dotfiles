...
local custom_icon_dir = "/usr/share/icons/" .. theme.icon_theme .. "/apps/scalable/"

theme.ic_icons = {
    ["Alacritty"] = custom_icon_dir .. "Alacritty.svg",
    ["telegram-desktop"] = custom_icon_dir .. "Telegram.svg",
    ["kitty"] = custom_icon_dir .. "kitty.svg",
}

theme.ic_fallback_icon = custom_icon_dir .. "anydesk.svg"
