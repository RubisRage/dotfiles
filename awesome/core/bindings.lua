...
binding.add_global_range {
    ...
    binding.new {
        ...
        on_press = function() awful.spawn(config.apps.terminal_file_manager) end,
    },
    ...
    binding.new {
        ...
        on_press = function() awful.spawn(config.apps.mixer) end,
    },
    ...
    binding.new {
        ...
        path = "Launcher",
        description = "Volume mixer",
        on_press = function() awful.spawn(config.apps.bluetooth_control) end,
    },
    ...
    binding.new {
        modifiers = { mod.super },
        triggers = binding.group.vim_motions,
        path = "Client",
        description = "Change focus",
        on_press = function(trigger) hclient.focus(nil, trigger.direction) end,
    },
